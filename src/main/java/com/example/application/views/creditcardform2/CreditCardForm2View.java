package com.example.application.views.creditcardform2;
...
@PageTitle("Credit Card Form2")
@Menu(icon = "line-awesome/svg/credit-card.svg", order = 9)
@Route(value = "credit-card-form2")
@AnonymousAllowed
public class CreditCardForm2View extends Div {
    ...
    public CreditCardForm2View() {
        addClassName("credit-card-form2-view");
